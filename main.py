...
testHand = [
    ...
    CardManagement.Card("Heart",14,"Queen",None),
    CardManagement.Card("Heart",14,"Jack",None),
    CardManagement.Card("Heart",10,"Ten",None),
    CardManagement.Card("Heart",5,"Five",None),
